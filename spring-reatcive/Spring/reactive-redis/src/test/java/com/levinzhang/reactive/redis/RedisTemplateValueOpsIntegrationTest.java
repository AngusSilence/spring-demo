package com.levinzhang.reactive.redis;

import com.levinzhang.reactive.redis.model.Employee;
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = SpringReactiveRedisApplication.class)
...
public class RedisTemplateValueOpsIntegrationTest {
    ...
    public void givenEmployee_whenSetWithExpiry_thenSetsWithExpiryTime() throws InterruptedException {
        ...
        fetchedEmployee.map(employee -> employee.getName())
